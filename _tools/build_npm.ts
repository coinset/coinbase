...
await build({
  ...
  package: {
    name: "@coinset/coinbase",
    version: Deno.args[0]?.replace(/^v/, ""),
    description: "Universal Coinbase API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/coinbase.git",
    },
    bugs: {
      url: "https://github.com/coinset/coinbase/issues",
    },
    homepage: "https://github.com/coinset/coinbase#readme",
    funding: {
      type: "patreon",
